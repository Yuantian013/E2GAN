    ...
    def forward(self, z, smooth=1., eval=False):
        ...
        if self.cur_stage == 0:
            if not eval:
                ...
                return self.to_rgb(h1), F.interpolate(h1, size=(4, 4), mode="bilinear").detach()
        if self.cur_stage == 1:
        ...
        if self.cur_stage == 1:
            ...
            if not eval:
                ...
                return self.to_rgb(h2), F.interpolate(h2, size=(4, 4), mode="bilinear").detach()
        ...
        if self.cur_stage == 2:
            ...
            if not eval:
                ...
                return self.to_rgb(h3), F.interpolate(h3, size=(4, 4), mode="bilinear").detach()
